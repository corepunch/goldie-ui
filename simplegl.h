...
typedef struct { char id[32]; vec3 color; float shininess; int transparent; } Material;
...
typedef struct { Mesh mesh; vec3 color; float shininess; int castsShadow,renderable,transparent; } SceneObj;
