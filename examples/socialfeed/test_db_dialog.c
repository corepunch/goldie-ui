...
static const form_ctrl_def_t author_edit_children[] = {
  ...
  { .class_name = "TextBox", .id = 1, .size = {0, 13}, .flags = WINDOW_FLEXSPACE, .text = "", .name = "edit_name" },
  { .class_name = "Label", .id = 0, .size = {0, 13}, .flags = 0, .text = "Avatar:", .name = "lbl_avatar" },
  { .class_name = "TextBox", .id = 2, .size = {0, 13}, .flags = WINDOW_FLEXSPACE, .text = "", .name = "edit_avatar" },
