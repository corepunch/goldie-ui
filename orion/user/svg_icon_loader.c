...
static const char *k_sysicon_names[] = {
    ...
    [sysicon_arrow_left_right           - SYSICON_BASE] = "arrows-horizontal",
    ...
    [sysicon_arrow_prompt               - SYSICON_BASE] = "submit",
    ...
    [sysicon_arrow_switch               - SYSICON_BASE] = "switch",
    [sysicon_arrow_up                   - SYSICON_BASE] = "arrow-up",
    [sysicon_arrow_up_down              - SYSICON_BASE] = "arrows-vertical",
    ...
    [sysicon_button                     - SYSICON_BASE] = "cursor",
    ...
    [sysicon_camera_add                 - SYSICON_BASE] = "camera-plus",
    ...
    [sysicon_character_edit             - SYSICON_BASE] = "edit-user",
    ...
    [sysicon_clipboard                  - SYSICON_BASE] = "clipboard",
    ...
    [sysicon_color_swatch               - SYSICON_BASE] = "color-swatch",
    ...
    [sysicon_crosshair                  - SYSICON_BASE] = "crosshair",
    [sysicon_cursor                     - SYSICON_BASE] = "cursor",
    [sysicon_delete                     - SYSICON_BASE] = "trash",
    [sysicon_dialogue                   - SYSICON_BASE] = "chat-bubble-text",
    ...
    [sysicon_door                       - SYSICON_BASE] = "door",
    ...
    [sysicon_eyedropper                 - SYSICON_BASE] = "pipette",
    [sysicon_eye_height                 - SYSICON_BASE] = NULL,
    [sysicon_eye_hide                   - SYSICON_BASE] = "eye-off",
    ...
    [sysicon_flag_blue                  - SYSICON_BASE] = "flag",
    ...
    [sysicon_folder_up                  - SYSICON_BASE] = "folder-arrow-up",
    ...
    [sysicon_grid_tile                  - SYSICON_BASE] = "grid",
    ...
    [sysicon_hand                       - SYSICON_BASE] = "hand-gesture",
    ...
    [sysicon_heart_add                  - SYSICON_BASE] = "heart-plus",
    ...
    [sysicon_image_add                  - SYSICON_BASE] = "add-media-image",
    ...
    [sysicon_interact                   - SYSICON_BASE] = "cursor",
    ...
    [sysicon_light_off                  - SYSICON_BASE] = "brightness-off",
    ...
    [sysicon_message                    - SYSICON_BASE] = "chat-bubble-text",
    [sysicon_missing                    - SYSICON_BASE] = "question-mark-circle",
    ...
    [sysicon_music                      - SYSICON_BASE] = "music-note-beamed",
    ...
    [sysicon_node_add                   - SYSICON_BASE] = "circle-plus",
    ...
    [sysicon_page_add                   - SYSICON_BASE] = "file-plus",
    [sysicon_page_copy                  - SYSICON_BASE] = "copy",
    [sysicon_page_data                  - SYSICON_BASE] = "data-base-alt",
    [sysicon_page_edit                  - SYSICON_BASE] = "file-edit",
    [sysicon_page_voxel                 - SYSICON_BASE] = NULL,
    [sysicon_paint_can                  - SYSICON_BASE] = "paint-bucket",
    ...
    [sysicon_pencil                     - SYSICON_BASE] = "pencil",
    ...
    [sysicon_scissors                   - SYSICON_BASE] = "scissors",
    ...
    [sysicon_tag_blue                   - SYSICON_BASE] = "tag",
...
static const char *k_picker_names[ICON_COUNT] = {
    ...
    [ICON_BRUSH                ] = "brush",
    [ICON_CASE_INSENSITIVE     ] = "font",
    [ICON_CHAIN_LINK           ] = "link",
    [ICON_CHESSBOARD           ] = "grid",
    [ICON_CLIPBOARD            ] = "clipboard",
    [ICON_COLOUR_PICKER        ] = "pipette",
    [ICON_COPY                 ] = "copy",
    [ICON_CROP                 ] = "crop",
    [ICON_CUT                  ] = "scissors",
    [ICON_CUT_2                ] = "scissors",
    ...
    [ICON_PAPER_EXPORT         ] = "export",
    [ICON_PAPER_JSON           ] = "code",
    [ICON_PAPER_NEW            ] = "file-plus",
